...
uncollapseLabraduck <- function(eta, F, G, W, gamma, upsilon, Xi, M0, C0, observations, seed, ret_mean = FALSE, apply_smoother = FALSE, ncores = -1L) {
    .Call('_stray_uncollapseLabraduck', PACKAGE = 'stray', eta, F, G, W, gamma, upsilon, Xi, M0, C0, observations, seed, ret_mean, apply_smoother, ncores)
}
